...
static ISO: Mutex<VecIso> = Mutex::new(VecIso { iso: smallvec::SmallVec::new(), nmis: smallvec::SmallVec::new() });
struct VecIso {
...
static MSI_CLAIMED_GSI: Mutex<bitvec::vec::BitVec> = Mutex::new(bitvec::vec::BitVec::repeat(false, 1024));
