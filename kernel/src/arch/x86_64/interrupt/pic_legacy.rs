...
pub unsafe fn init(off1: u8, off2: u8) {
    ...
    proof::audit_phys_alloc(0x8259_INIT, ((off1 as u64)<<8) | off2 as u64, CapTag::KERNEL);
}
...
pub fn disable_hard() {
    ...
    proof::audit_phys_alloc(0x8259_OFF, 0, CapTag::KERNEL);
}
...
pub unsafe fn enable_aeoi() {
    ...
    proof::audit_phys_alloc(0x8259_AEOI, 1, CapTag::KERNEL);
}
...
pub unsafe fn disable_aeoi() {
    ...
    mask_all();
    proof::audit_phys_alloc(0x8259_AEOI, 0, CapTag::KERNEL);
}
...
pub unsafe fn enable_smm() {
    ...
    proof::audit_phys_alloc(0x8259_SMM, 1, CapTag::KERNEL);
}
pub unsafe fn disable_smm() {
    proof::audit_phys_alloc(0x8259_SMM, 0, CapTag::KERNEL);
}
...
unsafe fn try_route_imcr_to_apic() {
    ...
    proof::audit_phys_alloc(0x1MCR_SW1, 1, CapTag::KERNEL);
}
