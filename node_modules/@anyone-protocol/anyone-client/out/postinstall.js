...
const downloadTextFile = (url, outputPath) => __awaiter(void 0, void 0, void 0, function* () {
...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const geo of geoipFiles) {
        const dest = path_1.default.join(binaryDir, geo.name);
        console.log(`Downloading ${geo.name}...`);
        yield downloadTextFile(geo.url, dest);
    }
